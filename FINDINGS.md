...
- The cast made to the brief (take T2) is a first pass: Lena wears two haircuts at once (the script adds the new one beside the base's instead of swapping it), dark where the brief says greying, and her base face's eye make-up; Sam keeps his base's moustache; Rocco's face is still close to Jorge's.
