...
- The cast made to the brief is a first pass. Take T2, which the game uses: Lena wears two haircuts at once, dark where the brief says greying, with her base face's eye make-up; Sam keeps his base's moustache; Rocco's face is still close to Jorge's. Take T3 swaps the haircut cleanly and drops the make-up, but grey set on the built hair materials shows nothing, and with a straight dark fringe and no make-up Lena reads less British than in T2; its close-ups caught Rocco and Sam mid-blink (both shots fall at the same point in the face loop).
