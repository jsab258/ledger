...
- A spoken answer arrives a while after its words: the voice takes about as long to make as it lasts, so an 18-second answer is heard about 20 seconds after it appears. The voice server also holds two copies of the voice model (about 5 GB of memory).
