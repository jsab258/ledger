...
<div class="wrap">
  ...
  <footer id="foot">Portraits: the local image model (Z-Image-Turbo, Apache-2.0), invented people not based on anyone. Voices: the game's voice engine (Chatterbox) speaking from each reference; the references are his approved clips, voices designed from a written description, and two northern English volunteer recordings per sex. Nothing here is in the game until you approve it.</footer>
</div>
