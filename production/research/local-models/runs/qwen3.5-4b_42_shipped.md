# The small-model test: the intent router on Qwen3.5-4B Q4_K_M, thinking off, 42, shipped

42 lines (set: 42), temperature 0, the shipped prompt and validator. Written by ledger/RouterFloor on 2026-09-23 21:12.
...
| prompt only, as shipped | 37/42 (88%) | 5 (12%) | 0 | 0 | 836 | 1033 |
...
| A | I slip the barman a tenner to tell me who's been asking about me. | novel | speech | `{"kind":"speech","verb":"none","args":{},"check":"none","amount":0,"effect":"nothing","magnitude":0,"target":"none","why":"player is asking ...` |
...
| C | I'll buy the next round for the whole bar. | novel | speech | `{"kind":"speech","verb":"none","args":{},"check":"none","amount":0,"effect":"nothing","magnitude":0,"target":"Sam","why":"buying drinks is j...` |
