# The small-model test: the intent router on Qwen3-4B-Instruct-2507 Q4_K_M, lines, examples+orders

299 lines (set: heldout), temperature 0, the shipped prompt and validator, 6 worked examples per line from 225. Written by ledger/RouterFloor on 2026-09-23 23:09.
...
| prompt only, as shipped | 274/299 (92%) | 23 (8%) | 2 | 0 | 1511 | 1946 |
