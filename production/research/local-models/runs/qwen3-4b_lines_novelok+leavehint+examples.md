# The small-model test: the intent router on Qwen3-4B-Instruct-2507 Q4_K_M, held-out lines, novelok+leavehint+examples

299 lines (set: heldout), temperature 0, the shipped prompt and validator, small-model wording: novelok + leavehint, 6 worked examples per line from 195. Written by ledger/RouterFloor on 2026-09-23 22:42.
...
| prompt only, as shipped | 274/299 (92%) | 23 (8%) | 2 | 0 | 1415 | 1823 |
...
| M07 | Envelope under this timetable's yours. Find something else to talk about. | pay_off | novel/cash/suspicion_down | `{"kind":"novel","check":"cash","amount":150,"effect":"suspicion_down","magnitude":0.1,"target":"clerk","why":"claiming ownership of envelope...` |
...
| M13 | just between us, Danny, keep your lot off my rank or they'll be picking their teeth up off this concrete | threaten(quiet) | threaten(loud) | `{"kind":"verb","verb":"threaten","args":{"tone":"loud"},"target":"Danny Ro","why":"keep crew off my rank"}` |
...
| M30 | That little business with the kiosk takings. I know about it, and I think you'll help me now. | use_hook | inform(Danny Ro) | `{"kind":"verb","verb":"inform","args":{"who":"Danny Ro"},"check":"cash","amount":50,"effect":"suspicion_up","magnitude":0.1,"target":"Danny ...` |
