# The small-model test: the intent router on Qwen3-4B-Instruct-2507 Q4_K_M, 42, examples+orders

42 lines (set: 42), temperature 0, the shipped prompt and validator, 6 worked examples per line from 225. Written by ledger/RouterFloor on 2026-09-23 23:17.
...
| prompt only, as shipped | 36/42 (86%) | 6 (14%) | 0 | 0 | 1780 | 2490 |
...
| B | I'm off. Night. | leave | speech | `{"kind":"speech"}` |
