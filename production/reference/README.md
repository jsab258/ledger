...
| `kcd2-town-arcades.jpg` | **THE PS5 CORNER'S BAR, from 23 September.** Kingdom Come: Deliverance II, a town street under arcades looking toward a gate tower, low sun. 3840 x 2160. | Supplied by Jafar on 23 September: "that game is my stated bar". A screenshot of Warhorse Studios' game (THIRD-PARTY.md): a comparison reference only, never shipped. |
| `kcd2-town-fountain.jpg` | The same bar, a town square with a fountain, people and carts, clear sky. 1650 x 825. | As above. |
