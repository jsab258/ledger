...
max_sessions: 2
status: REOPENED 2026-09-14 by Jafar. Was: CLOSED 2026-09-10, not on the ladder (closed by cd55a79c, an archiving commit, with no ruling naming what went with it; see production/queue/275). and untouched for 7 days 2026-09-02. Numbered 032 because 031 was taken by a different finding written the same hour. RISES 2026-09-02 (game-design/decision-2026-09-02-tiebreak-reversed-and-the-moat-item.md, Ruling 1): with ties to Unreal, (a) decides D1 and this item's printer is (a)'s instrument. Step one rides 027's first UE dispatch; the named change waits for the printed series.
