...
max_sessions: 1
status: REOPENED 2026-09-14 by Jafar. Was: CLOSED 2026-09-10, not on the ladder (closed by cd55a79c, an archiving commit, with no ruling naming what went with it; see production/queue/275). and untouched for 7 days 2026-09-02. systems-builder, one session, engine-neutral C#. FIRST UE-WAIT FILLER: the second builder slot of a day, ahead of every governance item, never the first slot, which is 027's.
