...
| A21.05 | Readable routes through ordinary environments | ours | done | a pavement on each side behind a kerb, the carriageway between, the yard's mouth and the road running on to the quay: where a person walks and where a car goes read at a glance, 24 Sep: [frame](production/art/compare/stage1-2026-09-24/hook-max-sooty-bevel.png) |
...
| A22.05 | Materials distinguishable as wood, metal, glass, cloth and stone | floor | done | each reads as itself: the crates' and pallet's bare wood, the cars', bins' and lamp posts' metal, the shop glass with the room behind it, the clothes' knit and denim, and brick, stone sills and kerbs, 24 Sep: [fish market](production/art/compare/stage1-2026-09-24/clutter-fish-market.png), [corner](production/art/compare/ps5-corner-2026-09-24/corner-metahuman-idle.png) |
| A22.06 | Object edges that do not all look infinitely sharp | floor | done | every piece of the street shorter than 12 m and longer than 0.25 m is rounded 6 mm at export (two steps at the corner, one elsewhere; cf1a0e62); close up, the transom rail and the door casing catch a thin line of light along the rounding instead of ending in a knife edge, 24 Sep: [crop](production/art/compare/stage1-2026-09-24/edges-corner-zoom.png) |
...
| A22.08 | Believable joins between walls, floors, roofs and terrain | floor | done | on a straight-on frame the joins are built, not butted: slate eaves over a gutter and a dentil course, sills and heads let into the brick, fascias on consoles, the wall's foot on the footway behind a stallriser or plinth, 24 Sep: [parade bay](production/art/compare/stage1-2026-09-24/facade-east-parade-bay0.png) |
...
| A22.11 | Wear and dirt consistent with use and exposure | floor | done | the scene file's ten stains stand as decals in Unreal (stainsStood=10, f0de9751): water streaks down the party walls, moss at the west row's foot, broken tarmac, manholes; over the scanned sooty and worn brick and the walls' damp feet, 24 Sep: [across the street](production/art/compare/stage1-2026-09-24/camB-day-stains.png), [Hook view](production/art/compare/stage1-2026-09-24/hook-max-sooty-bevel.png) |
| A22.12 | Furnishing and clutter consistent with a place's function | floor | done | each thing is where its trade puts it: crates out in front of the fish market, pallet, crates and an oil drum at the yard's mouth, cones, barrier and a skip where the road is up, an A-board outside a shop, a public bin per shop group, a post box and a phone box on the pavement, 24 Sep: [fish market](production/art/compare/stage1-2026-09-24/clutter-fish-market.png), [Hook view](production/art/compare/stage1-2026-09-24/hook-max-hill5b.png) |
...
| A23.01 | Lighting that establishes readable shapes and space | floor | done | under the sheet's overcast the street still reads in depth: the facades' planes, reveals and roofs separate by shade, and the haze steps the hill back behind the street's end, 24 Sep: [frame](production/art/compare/stage1-2026-09-24/hook-max-sooty-bevel.png) |
| A23.02 | Shadows connecting people and objects to their surroundings | floor | done | close up in the corner, a person's feet and a car's wheels sit in their own contact shadow on the flags and the road, and nothing hovers, 24 Sep: [crop](production/art/compare/stage1-2026-09-24/contact-shadows.png) |
