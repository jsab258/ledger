...
- 2026-09-23 **Your Epic sign-in worked:** MetaHuman Creator reached Epic's auto-rigging service and is applying the rig. Two things remain before a MetaHuman is fully usable. The MetaHuman Creator Core Data needs installing beside the engine, which is your hands in the Epic Games Launcher. And two character settings in the project need switching on, one click on "Enable Missing".
