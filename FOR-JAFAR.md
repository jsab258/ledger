...
- 2026-09-23 **Your Epic sign-in may still be waiting:** I said it had worked, too early. The auto-rig bar stayed at 0 per cent, which usually means the Epic sign-in page is still open in a browser window somewhere, or the sign-in hasn't finished. Two things remain before a MetaHuman is fully usable. The MetaHuman Creator Core Data needs installing beside the engine, which is your hands in the Epic Games Launcher. And two character settings in the project need switching on, one click on "Enable Missing".
